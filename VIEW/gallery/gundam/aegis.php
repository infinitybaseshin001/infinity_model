        ...
        <div class="js-fh5co-waypoint fh5co-project-detail" id="fh5co-main" data-colorbg="">
			...
			<div class="row row-bottom-padded-sm animate-box">
                            <div class="col-md-12">
                                ...
                                <br><br>
                                そんなでフリーダムやストライクは何回か作ってたんですが、他SEEDガンダム展開再開の第四弾・イージス！^^<br>
                                最近の技術を惜しみなく投入し、デティールからプロポーションから可動からかなりのレベルです♪
                                <br><br>
                                MS本体だけ見れば肩デカすぎだったりゲテモノだったりなんですが、変形時のバランス的にでしょうね＾＾；<br>
                                それでもサイドアーマーでバランス取られてたり、トータルで見るとかっこいいので、デカールなどのみで特にイジってませんｗ
                                <br><br>
                                唯一の変形GATシリーズ、変形だけでなくイージスの決定版としても見れると思います。
                        ...
                        <div class="row row-bottom-padded-sm animate-box">
                            <div class="col-md-12">
                                ...
                                <img src="/gallery/img_gallery/gundam/aegis/gal<?=$i?>.JPG" class="img-responsive" alt="MGイージス"></a></figure>
                            </div>
                        </div>
                        <? } ?>
                        ...
                        <div class="row row-bottom-padded-sm animate-box">
                            <div class="col-md-12">
                                ...
                                <ul class="fh5co-list-style-1 fh5co-inline">
                                    <li>制作状況</li>
                                    <li><img src = "/gallery/img_gallery/gundam/aegis/model1.JPG" alt = "MGイージス" width = "240" height = "180"><br>
                                        箱はMGの標準大きめサイズです。<br>
                                        厚みも普通でブリッツほどではないかもですが<br>
                                        外装が小分けされ、若干手間があります・・・<br>
                                        特にサイドアーマーなど最近のにしては<br>
                                        合わせ目が多め（ウェポン含む）です。</li>
                                    <li><img src = "/gallery/img_gallery/gundam/aegis/model2.JPG" alt = "MGイージス" width = "180" height = "240"><br>
                                        サイドアーマーの詳しい後ハメは<br>
                                        こちらのURLが参考になるかと思います。<br>
                                        <a href="http://gn-001tm9banaaan.doorblog.jp/archives/3597462.html">イージスのサイドアーマー後ハメ参考</a></li>
                                    
                                </ul>
                                <ul class="fh5co-list-style-1 fh5co-inline">
                                    <li>塗装状況</li>
                                    <li><img src = "/gallery/img_gallery/gundam/aegis/tosou1.JPG" alt = "MGイージス" width = "240" height = "180"><br>
                                        塗装はMG開発画稿がカッコ良かったので、<br>
                                        アニメ版よりもトーンを落としたカラーリングにしています。<br>
                                        マスキングはないので楽です♪</li>
                                    <li><img src = "/gallery/img_gallery/gundam/aegis/tosou2.JPG" alt = "MGイージス" width = "240" height = "180"><br>
                                        新SEED恒例のマーキング・デカールですが、<br>
                                        これが結構量多くてめんどくさいでｓ<br>
                                        ただでさえこのキットは手足が紛らわしくてアレなのもあって^^;<br>
                                        そこでスジボリとどっちでデティ追加するか？？<br>
                                        と言われたら悩ましいんですけどね^^;</li>
                        ...
                        <div class="row row-bottom-padded-sm animate-box">
                            <div class="col-md-12">
                                ...
                                ピンク･･･GXハーマンレッド+ガイアのピュアピュアホワイト+ガイアの橙黄色<br><br>

                                ホワイト･･･フィニッシャーズのファンデーションホワイト<br><br>

                                オレンジ･･･ガイアの橙黄色<br><br>

                                濃紺･･･ガイアの純色シアン+ガイアのピュアブラック<br><br>
